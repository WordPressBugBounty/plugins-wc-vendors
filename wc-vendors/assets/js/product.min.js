          ...
          var t,
            ...
            r =
              ...
              1 == wcv_frontend_product.require_download_file &&
                ((a = (t = p('.download_file_table')).length),
                (i = !0),
                ('hidden' === (r = p('#_downloadable').attr('type')) &&
                  'yes' === p('#_downloadable').val()) ||
                  ('checkbox' === r && p('#_downloadable').is(':checked'))) &&
              ...
              u() || (o = !0),
              p('#product_save_button'));
          r.length &&
            (o ? r.removeAttr('disabled') : r.attr('disabled', 'disabled'));
        }),
        function() {
          var e = !0;
          return (
