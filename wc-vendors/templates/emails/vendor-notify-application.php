...
do_action( 'woocommerce_email_header', $email_heading, $email ); ?>
    ...
    <p><?php printf( /* translators: %1$s: vendor name, %2$s: site name */ esc_html__( 'Hi there. This is a notification about your %1$s application on %2$s.', 'wc-vendors' ), esc_html( wcv_get_vendor_name( true, false, $user->ID ) ), esc_html( get_option( 'blogname' ) ) ); ?></p>
