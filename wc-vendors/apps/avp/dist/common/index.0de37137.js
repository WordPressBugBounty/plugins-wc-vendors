...
import { i as ft } from './initDefaultProps.14498c5d.js';
import { D as Oo, u as $o, v as To } from './antd.01cefdb7.js';
function At(e, o) {
  const { key: n } = e;
  let t;
  return (
...
const ko = ue({
    ...
    setup(e, o) {
      ...
      t({
        ...
        scrollTo: c => {
          var v;
          return (v = P.value) === null || v === void 0
            ? void 0
            : v.scrollTo(c);
        }
      });
      const E = V(() => {
          ...
          const v =
            (c = e.displayValues[0]) === null || c === void 0
              ? void 0
              : c.value;
