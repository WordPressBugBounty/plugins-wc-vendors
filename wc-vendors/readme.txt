...
= WC Vendors – WooCommerce Multi Vendor Plugin =

**🏆 #1 WooCommerce multi vendor plugin for turning your WooCommerce store into a thriving marketplace.** Trusted by over 8,000 stores.
...
= FAST & EASY TO USE – THE BEST WOOCOMMERCE MULTI VENDOR PLUGIN =
...
= Grow With No Restrictions – Create A Thriving Multi-Seller Marketplace =
...
= Version 2.7.2.2 - 14th September 2026 =
 * Security Fix: Hardened the commission CSV export (reported by Ananda Dhakal via Patchstack)

= Version 2.7.2.1 - 28th August 2026 =
 * Security Fix: Hardened vendor product permissions (reported by Usama Arshad via WPScan)
 * Security Fix: Hardened vendor order action permissions (reported by Usama Arshad via WPScan)
 * Security Fix: Hardened vendor order permissions (reported by Bhaveshkumar Parmar via WPScan)
