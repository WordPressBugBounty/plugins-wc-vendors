...
<table class="form-table">
        ...
        <tr>
            ...
            <td>
                <label for="pv_shop_html_enabled">
                    ...
                    <?php esc_html_e( 'Enable HTML for the shop description', 'wc-vendors' ); ?>
                </label>
            </td>
        </tr>
    ...
    <?php if ( apply_filters( 'wcvendors_admin_user_meta_shop_name_enable', true ) ) : ?>
        ...
        <tr>
            <th><label for="pv_shop_name"><?php esc_html_e( 'Shop name', 'wc-vendors' ); ?></label></th>
            <td><input type="text" name="pv_shop_name" id="pv_shop_name"
                        value="<?php echo esc_attr( get_user_meta( $user->ID, 'pv_shop_name', true ) ); ?>" class="regular-text">
            </td>
        </tr>
    ...
    <?php if ( apply_filters( 'wcvendors_admin_user_meta_paypal_enable', true ) ) : ?>
        ...
        <tr>
            <th><label for="pv_paypal"><?php esc_html_e( 'PayPal E-mail', 'wc-vendors' ); ?> <span
                            class="description"></span></label></th>
            <td><input type="email" name="pv_paypal" id="pv_paypal"
                        value="<?php echo esc_attr( get_user_meta( $user->ID, 'pv_paypal', true ) ); ?>" class="regular-text">
            </td>
        </tr>
    ...
    <tr>
        <th><label for="wcv_paypal_masspay_wallet"><?php esc_html_e( 'PayPal MassPay Wallet', 'wc-vendors' ); ?> <span
                        class="description"></span></label></th>
    ...
    <tr>
        <th><label for="wcv_paypal_masspay_venmo_id"><?php esc_html_e( 'Venmo ID', 'wc-vendors' ); ?> <span
                        class="description"></span></label></th>
        <td><input type="text" name="wcv_paypal_masspay_venmo_id" id="wcv_paypal_masspay_venmo_id"
                value="<?php echo esc_attr( get_user_meta( $user->ID, 'wcv_paypal_masspay_venmo_id', true ) ); ?>" class="regular-text">
                <p class="description"><?php esc_html_e( 'Your Venmo ID or Phone number', 'wc-vendors' ); ?></p>
        </td>
    </tr>
    ...
    <?php if ( apply_filters( 'wcvendors_admin_user_meta_bank_details_enable', true ) ) : ?>
        ...
        <tr>
            <th><label for="wcv_bank_account_name"><?php esc_html_e( 'Bank Account Name', 'wc-vendors' ); ?> <span
                            class="description"></span></label></th>
            <td><input type="text" name="wcv_bank_account_name" id="wcv_bank_account_name"
                        value="<?php echo esc_attr( get_user_meta( $user->ID, 'wcv_bank_account_name', true ) ); ?>"
                        class="regular-text">
            </td>
        </tr>
        <tr>
            <th><label for="wcv_bank_account_number"><?php esc_html_e( 'Bank Account Number', 'wc-vendors' ); ?> <span
                            class="description"></span></label></th>
            <td><input type="text" name="wcv_bank_account_number" id="wcv_bank_account_number"
                        value="<?php echo esc_attr( get_user_meta( $user->ID, 'wcv_bank_account_number', true ) ); ?>"
                        class="regular-text">
            </td>
        </tr>
        <tr>
            <th><label for="wcv_bank_name"><?php esc_html_e( 'Bank Name', 'wc-vendors' ); ?> <span
                            class="description"></span></label></th>
            <td><input type="text" name="wcv_bank_name" id="wcv_bank_name"
                        value="<?php echo esc_attr( get_user_meta( $user->ID, 'wcv_bank_name', true ) ); ?>" class="regular-text">
            </td>
        </tr>
        <tr>
            <th><label for="wcv_bank_routing_number"><?php esc_html_e( 'Routing Number', 'wc-vendors' ); ?> <span
                            class="description"></span></label></th>
            <td><input type="text" name="wcv_bank_routing_number" id="wcv_bank_routing_number"
                        value="<?php echo esc_attr( get_user_meta( $user->ID, 'wcv_bank_routing_number', true ) ); ?>"
                        class="regular-text">
            </td>
        </tr>
        <tr>
            <th><label for="wcv_bank_iban"><?php esc_html_e( 'IBAN', 'wc-vendors' ); ?> <span
                            class="description"></span></label></th>
            <td><input type="text" name="wcv_bank_iban" id="wcv_bank_iban"
                        value="<?php echo esc_attr( get_user_meta( $user->ID, 'wcv_bank_iban', true ) ); ?>" class="regular-text">
            </td>
        </tr>
        <tr>
            <th><label for="wcv_bank_bic_swift"><?php esc_html_e( 'BIC/SWIFT', 'wc-vendors' ); ?> <span
                            class="description"></span></label></th>
            <td><input type="text" name="wcv_bank_bic_swift" id="wcv_bank_bic_swift"
                        value="<?php echo esc_attr( get_user_meta( $user->ID, 'wcv_bank_bic_swift', true ) ); ?>"
                        class="regular-text">
            </td>
        </tr>
    ...
    <?php if ( apply_filters( 'wcvendors_admin_user_meta_commission_rate_enable', true ) ) : ?>
        ...
        <tr>
            <th><label for="pv_custom_commission_rate"><?php esc_html_e( 'Commission rate', 'wc-vendors' ); ?> (%)</label></th>
            <td><input type="number" step="0.01" max="100" min="0" name="pv_custom_commission_rate"
                        placeholder="<?php esc_html_e( 'Leave blank for default', 'wc-vendors' ); ?>"
                        id="pv_custom_commission_rate"
                        value="<?php echo esc_attr( get_user_meta( $user->ID, 'pv_custom_commission_rate', true ) ); ?>"
                        class="regular-text">
            </td>
        </tr>
    ...
    <?php if ( apply_filters( 'wcvendors_admin_user_meta_give_tax_enable', true ) ) : ?>
        ...
        <tr>
            <th><label for="wcv_give_vendor_tax"><?php esc_html_e( 'Give Tax', 'wc-vendors' ); ?> (%)</label></th>
            <td>
                <label for="wcv_give_vendor_tax">
                    ...
                    <?php printf( /* Translators: %s vendor name */ esc_html__( 'Tax override for %s', 'wc-vendors' ), wcv_get_vendor_name( true, false ) ); //phpcs:ignore ?>
                </label>
            </td>
        </tr>
    ...
    <?php if ( apply_filters( 'wcvendors_admin_user_meta_give_shipping_enable', true ) ) : ?>
        ...
        <tr>
            <th><label for="wcv_give_vendor_shipping"><?php esc_html_e( 'Give Shipping', 'wc-vendors' ); ?> (%)</label></th>
            <td>
                <label for="wcv_give_vendor_shipping">
                    ...
                    <?php printf( /* Translators: %s vendor name */ esc_html__( 'Shipping override for %s', 'wc-vendors' ), wcv_get_vendor_name( true, false ) ); //phpcs:ignore ?>
                </label>
            </td>
        </tr>
    ...
    <?php if ( apply_filters( 'wcvendors_admin_user_meta_seller_info_enable', true ) ) : ?>
        ...
        <tr>
            <th><label for="pv_seller_info"><?php esc_html_e( 'Seller info', 'wc-vendors' ); ?></label></th>
    ...
    <?php if ( apply_filters( 'wcvendors_admin_user_meta_shop_description_enable', true ) ) : ?>
        ...
        <tr>
            <th><label for="pv_shop_description"><?php esc_html_e( 'Shop description', 'wc-vendors' ); ?></label>
            </th>
