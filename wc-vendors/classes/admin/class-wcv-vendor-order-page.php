            ...
            foreach ( $valid as $order_item_id => $item ) {
                ...
                if ( ! empty( $meta_data ) ) {
                    ...
                    foreach ( $meta_data as $meta ) {
                        ...
                        $meta_value           = is_array( $meta->value ) ? implode( ', ', $meta->value ) : $meta->value;
                        $order_products_html .= '<tr><th>' . wp_kses_post( rawurldecode( $meta->key ) ) . ':</th><td>' . rawurldecode( $meta_value ) . '</td></tr>';
                    }
