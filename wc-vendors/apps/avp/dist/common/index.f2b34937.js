...
import { u as K, r as j } from './responsiveObserve.c3ec2d73.js'
import { b8 as P } from './VendorStore.03335c4e.js'
const _ = Symbol('rowContextKey'),
  ...
  ne = W({
    ...
    setup(e, t) {
      ...
      const { prefixCls: o, direction: s } = E('row', e),
        [G, y] = z(o)
      let b
      const v = K(),
  ...
  ae = W({
    ...
    setup(e, t) {
      ...
      const { gutter: o, supportFlexGap: s, wrap: G } = J(),
        { prefixCls: y, direction: b } = E('col', e),
        [v, x] = ee(y),
        S = $(() => {
