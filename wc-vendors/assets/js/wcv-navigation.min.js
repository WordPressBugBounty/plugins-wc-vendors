!(function(e, b) {
  e(document).ready(function(d) {
    ...
    let t = d('.wcv-dashboard-menu.secondary'),
      ...
      c = d('.wcv-dashboard-menu.primary'),
      r = d('#wcv-navigation')
    function e() {
      let o = r.width(),
        i = s.outerWidth(!0),
      ...
      c.find('li').each(function() {
        ...
        c.find('li').each(function(e, t) {
          ...
          0 < e && (n += 24), (n += s) + i > o && -1 === a && (a = e)
        }),
        -1 !== a &&
          (s.show().css('display', 'flex'),
          c.find('li').each(function(e) {
            e >= a && d(this).appendTo(t)
          }))
    }
    r.hasClass('wcv-show-all-menu-items') || (e(), d(window).on('resize', e))
    ;(h =
    ...
    let n = d('.wcv-store-setup-steps'),
      a = d('.wcv-store-setup-progress-bar'),
    ...
    }
    {
      ...
      if (t) {
        ...
        let c = t.querySelector('.wcv-more-tabs'),
          r = t.querySelector('.wcv-more-btn'),
          l = t.querySelector('.wcv-more-dropdown')
        if (h && c && r && l) {
          let a = Array.from(h.querySelectorAll(':scope > li'))
          function g() {
            a.forEach(e => e.classList.remove('wcv-tab-overflow')),
              c.classList.remove('wcv-more-visible'),
              (l.innerHTML = ''),
              r.classList.remove('wcv-more-btn--active')
            var e = t.offsetWidth,
              o = a.map(e => e.offsetWidth),
              i = o.reduce((e, t) => e + t, 0)
            if (!(i <= e)) {
              c.classList.add('wcv-more-visible')
              var n = e - c.offsetWidth
              let t = 0,
                s = a.length
              ...
              for (let e = s; e < a.length; e++)
                a[e].classList.add('wcv-tab-overflow')
              var i = a.findIndex(e => e.classList.contains('active')),
                e =
                  (i >= s &&
                    0 < s &&
                    (a[s - 1].classList.add('wcv-tab-overflow'),
                    a[i].classList.remove('wcv-tab-overflow')),
                  a.filter(e => e.classList.contains('wcv-tab-overflow')))
              0 === e.length
                ? c.classList.remove('wcv-more-visible')
...
let getPlaceHolderText = e => {
  ...
  buildCustomSelect = e => {
    ...
    var t = e.multiple,
      ...
      c =
        ((a.innerHTML = getPlaceHolderText(e)),
      ...
      r =
        ...
        o.appendChild(i),
        e.options)
    ;(c ? buildHierarchicalOptions : buildFlatOptions)(i, r, t, n, a, e, s),
  ...
  buildHierarchicalOptions = (t, s, o, i, n, a, c) => {
    let r = new Map()
    var l = new Map()
    for (let e = 0; e < s.length; e++) {
      var d = s[e],
        ...
        d = createOptionItem(d, e, o, i, n, a, c)
  ...
  buildFlatOptions = (t, s, o, i, n, a, c) => {
    for (let e = 0; e < s.length; e++) {
      var r = s[e],
        r = createOptionItem(r, e, o, i, n, a, c)
      t.appendChild(r)
    }
  },
  createOptionItem = (e, t, o, i, n, a, s) => {
    ...
    return (
      ...
      c.addEventListener('click', function(e) {
        ...
        var t,
          ...
          e = a.options[s]
        if (o) (e.selected = !e.selected), c.classList.toggle('selected')
        else {
          for (let e = 0; e < a.options.length; e++)
            e !== s &&
              ((a.options[e].selected = !1),
              a.parentNode
...
function showTooltip(s) {
  ...
  if (s) {
    ...
    if (o && i) {
      ...
      var a = s.top - n.height < 0
      a && (e = s.height + 10),
        (o.style.top = e + 'px'),
        (o.style.left = t + 'px'),
        i &&
          ((o = i.getBoundingClientRect()),
          (n = a ? -o.height : n.height),
          (s = s.width / 2 - o.width / 2 - t + 4),
          (i.style.top = n + 'px'),
          (i.style.left = s + 'px'),
          (i.style.transform = a ? 'rotate(180deg)' : ''))
    }
  }
}
let addAccordion = () => {
    var e = document.querySelector('#wcv-store-settings .wcv-tabs')
    let a = document.querySelectorAll('#wcv-store-settings .tabs-content')
    if (
      e &&
  ...
  productEditAccordion = () => {
    ...
    let a = wcvendor_dashboard.product_meta_tabs
    e.forEach(t => {
      var s = t.id
      if (a[s]) {
        var o = a[s],
