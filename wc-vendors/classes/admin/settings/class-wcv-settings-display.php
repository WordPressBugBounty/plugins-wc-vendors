        ...
        public function get_settings( $current_section = '' ) {
            ...
            if ( 'advanced' === $current_section ) {
                ...
                $settings = apply_filters(
                    ...
                    array(
                        ...
                        array(
                            'title'             => __( 'Products per page', 'wc-vendors' ),
                            'desc'              => __( 'How many products to show per page on the Vendor Dashboard', 'wc-vendors' ),
                        ...
                        array(
                            'title' => __( 'Permission Denied Message', 'wc-vendors' ),
                            'type'  => 'title',
                            'desc'  => __( 'Message to display to guests attempting to access the vendor dashboard.', 'wc-vendors' ),
                            'id'    => 'permission_denied_message',
                        ),
                        array(
                            'title'    => __( 'Message Content', 'wc-vendors' ),
                            'desc'     => __( 'The message shown to guests when they try to access the vendor dashboard.', 'wc-vendors' ),
                            'id'       => 'wcvendors_permission_denied_message',
                            'default'  => sprintf(
                                '%s<br/><br/>%s',
                            ...
                            'type'     => 'wysiwyg',
                            'desc_tip' => __( 'This message is shown to guests when they try to access the vendor dashboard.', 'wc-vendors' ),
                            'editor'   => array(
                                'tinymce'       => true,
                                'quicktags'     => true,
                                'media_buttons' => false,
                        ...
                        array(
                            'type'    => 'text',
                            'id'      => 'wcvendors_permission_denied_message_button_text',
                            'title'   => __( 'Button Text', 'wc-vendors' ),
                            'default' => __( 'Register as a Vendor', 'wc-vendors' ),
                        ),
                        array(
                            'type' => 'sectionend',
                            'id'   => 'permission_denied_message',
            ...
            if ( maybe_load_new_dashboard() ) {
                $settings = array_filter(
                    $settings,
                    function ( $setting ) {
                        return 'wcvendors_shop_settings_page_id' !== $setting['id'] && 'wcvendors_product_orders_page_id' !== $setting['id'];
                    }
                );
            }
