jQuery(function(o) {
  ...
  o('.wcv-img-id').each(function() {
    var c = this.id;
    o('.wcv-file-uploader-add' + c).on('click', function(e) {
      var t, n, a, i, r;
      return (
        e.preventDefault(),
        (i = o('#' + (t = c))),
        ...
        (n = wp.media({
          ...
          (a = n
            ...
            .first()
            .toJSON()),
            o.trim(a.url.length) < 0 ||
              (i.val(a.id).change(),
              o('.wcv-file-uploader-add' + t).addClass('hidden'),
              o('.wcv-file-uploader-delete' + t).removeClass('hidden'),
              'image' === r
                ? ((e = (a.sizes.thumbnail || a).url),
                  o('.wcv-file-uploader' + t).append(
                    '<img src="' +
                      e +
                      '" alt="' +
                      a.caption +
                ...
                ? ((e = {
                  ...
                  o.post(wcv_frontend_general.ajax_url, e, function(e) {
                    o('.wcv-file-uploader' + t).append(e);
                  }))
                : o('.wcv-file-uploader' + t).append(
      ...
      o('.wcv-file-uploader-delete' + c).on('click', function(e) {
        e.preventDefault(),
          o('.wcv-file-uploader' + c).html(''),
          o('input[id=' + c + ']').val(''),
          o('.wcv-file-uploader-delete' + c).addClass('hidden'),
          o('.wcv-file-uploader-reset' + c).addClass('hidden'),
          o('.wcv-file-uploader-add' + c).removeClass('hidden');
      });
  }),
    ...
    o('#clear_button').click(function(e) {
      e.preventDefault();
      ...
      e.val(e.data('default')),
        ...
        o('.wcv-order-header .wcv-form').submit();
    }),
    o('#clear_button_commission').click(function(e) {
      e.preventDefault();
      var e = o('#_wcv_commission_start_date_input'),
        t = o('#_wcv_commission_end_date_input');
      e.val(e.data('default')),
        t.val(t.data('default')),
        o('.wcv-commission-header .wcv-form').submit();
    }),
    o('#clear_button_report').click(function(e) {
      e.preventDefault();
