...
class WCVendors_Admin_Setup_Wizard {
    ...
    public function wcv_setup_pages_save() {
        ...
        $vendor_dashboard_page_id = isset( $_POST['wcvendors_vendor_dashboard_page_id'] ) ? sanitize_text_field( $_POST['wcvendors_vendor_dashboard_page_id'] ) : '';
        $vendors_page_id          = isset( $_POST['wcvendors_vendors_page_id'] ) ? sanitize_text_field( $_POST['wcvendors_vendors_page_id'] ) : '';
        $terms_page_id            = isset( $_POST['wcvendors_vendor_terms_page_id'] ) ? sanitize_text_field( $_POST['wcvendors_vendor_terms_page_id'] ) : '';
        $shop_settings_page_id    = isset( $_POST['wcvendors_shop_settings_page_id'] ) ? sanitize_text_field( $_POST['wcvendors_shop_settings_page_id'] ) : '';
        $product_orders_page_id   = isset( $_POST['wcvendors_product_orders_page_id'] ) ? sanitize_text_field( $_POST['wcvendors_product_orders_page_id'] ) : '';
