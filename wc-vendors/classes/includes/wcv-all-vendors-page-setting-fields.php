...
$general_fields    = array(
    ...
    array(
        'id'          => 'vendor_label_singular',
        'title'       => __( 'Singular term', 'wc-vendors' ),
        'desc'        => __( 'What to call this vendor on the front end and in emails sent to them, for example Instructor. Leave blank to use the site wide term.', 'wc-vendors' ),
        'type'        => 'text',
        'default'     => '',
        'placeholder' => wcv_get_vendor_name(),
        'is_pro'      => false,
        'intro'       => __( 'Overrides the site wide term for this vendor only. Admin screens always use the site wide term.', 'wc-vendors' ),
    ),
    array(
        'id'          => 'vendor_label_plural',
        'title'       => __( 'Plural term', 'wc-vendors' ),
        'desc'        => __( 'The plural form of the term above, for example Instructors. Leave blank to use the site wide term.', 'wc-vendors' ),
        'type'        => 'text',
        'default'     => '',
        'placeholder' => wcv_get_vendor_name( false ),
        'is_pro'      => false,
        'intro'       => __( 'Overrides the site wide plural term for this vendor only. Admin screens always use the site wide term.', 'wc-vendors' ),
    ),
    array(
        'id'      => 'verified_vendor',
...
$commission_payout_fields = array(
    ...
    array(
        ...
        'default'          => '',
        'options'          => array(
            'paypal' => __( 'PayPal Email', 'wc-vendors' ),
            'venmo'  => __( 'Venmo ID', 'wc-vendors' ),
        ),
        'is_pro'           => false,
        'render_condition' => array(
            'key'   => 'payout_method',
