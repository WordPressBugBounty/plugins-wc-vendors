...
class WCVendors_Admin_Settings extends WC_Admin_Settings {
    ...
    /**
     * Check if the vendor dashboard page is valid and have the correct shortcodes.
     *
     * @since 2.5.0
     *
     * @return void
     */
    public static function check_vendor_dashboard_page_validity() {
        global $current_tab;
        ...
        if ( ! isset( $_POST['wcvendors_vendor_dashboard_page_id'] ) ) { // phpcs:ignore
            return;
        }

        $vendor_dashboard_page_id = absint( $_POST['wcvendors_vendor_dashboard_page_id'] ); // phpcs:ignore

        if ( ! $vendor_dashboard_page_id ) {
            return;
        }

        $vendor_dashboard_page = get_post( $vendor_dashboard_page_id );
    ...
    /**
     * Build custom attribute output.
     *
     * @since 2.5.0
     * @version 2.5.0
     *
     * @param array $custom_attributes Custom attributes array.
     */
    public static function build_custom_attribute( $custom_attributes ) {
