import { _ as Oe } from '../main.5c2e1de1.js';
import {
  F as De,
  i as ut,
  C as Ta,
...
const vp = async (e, t, n) =>
  ...
  wp = k({
    ...
    setup(e) {
      const t = $e(() =>
          Oe(
            () => import('../components/Filter.c429fb37.js'),
            [
              window.wcv_dashboard_data.pluginDirUrl +
                '/dist/components/Filter.c429fb37.js',
              window.wcv_dashboard_data.pluginDirUrl +
                '/dist/common/vendor.6b2451aa.js',
              window.wcv_dashboard_data.pluginDirUrl +
                '/dist/common/index.282cac68.js',
              window.wcv_dashboard_data.pluginDirUrl +
                '/dist/common/createLucideIcon.aebff54c.js',
              window.wcv_dashboard_data.pluginDirUrl +
                '/dist/common/antd.138ea4fd.js',
              window.wcv_dashboard_data.pluginDirUrl +
                '/dist/common/index.ad90af7f.js',
              window.wcv_dashboard_data.pluginDirUrl +
                '/dist/common/index.eea31faf.js',
              window.wcv_dashboard_data.pluginDirUrl +
                '/dist/common/index.6d9f89df.js',
              window.wcv_dashboard_data.pluginDirUrl + '/dist/main.5c2e1de1.js',
              window.wcv_dashboard_data.pluginDirUrl +
                '/dist/assets/Filter-7113684a.css'
            ],
            import.meta.url
          )
        ),
        n = $e(() =>
          Oe(
            () => import('../components/Metrics.f6b9281b.js'),
            [
              window.wcv_dashboard_data.pluginDirUrl +
                '/dist/components/Metrics.f6b9281b.js',
              window.wcv_dashboard_data.pluginDirUrl +
                '/dist/common/vendor.6b2451aa.js',
              window.wcv_dashboard_data.pluginDirUrl +
                '/dist/common/index.1c336f1b.js',
              window.wcv_dashboard_data.pluginDirUrl +
                '/dist/common/createLucideIcon.aebff54c.js',
              window.wcv_dashboard_data.pluginDirUrl +
                '/dist/common/antd.138ea4fd.js',
        ...
        r = $e(() =>
          Oe(
            () => import('../components/TopVendors.76ffe15c.js'),
            [
              window.wcv_dashboard_data.pluginDirUrl +
                '/dist/components/TopVendors.76ffe15c.js',
              window.wcv_dashboard_data.pluginDirUrl +
                '/dist/common/vendor.6b2451aa.js',
              window.wcv_dashboard_data.pluginDirUrl +
                '/dist/common/index.b29ae5be.js',
              window.wcv_dashboard_data.pluginDirUrl +
                '/dist/common/createLucideIcon.aebff54c.js',
              window.wcv_dashboard_data.pluginDirUrl +
                '/dist/common/antd.138ea4fd.js',
        ...
        o = $e(() =>
          Oe(
            () => import('../components/PendingVendors.f7e38419.js'),
            [
              window.wcv_dashboard_data.pluginDirUrl +
                '/dist/components/PendingVendors.f7e38419.js',
              window.wcv_dashboard_data.pluginDirUrl +
                '/dist/common/vendor.6b2451aa.js',
              window.wcv_dashboard_data.pluginDirUrl +
                '/dist/common/createLucideIcon.aebff54c.js',
        ...
        i = $e(() =>
          Oe(
            () => import('../components/HelpFulLinks.e736d868.js'),
            [
              window.wcv_dashboard_data.pluginDirUrl +
                '/dist/components/HelpFulLinks.e736d868.js',
              window.wcv_dashboard_data.pluginDirUrl +
                '/dist/common/vendor.6b2451aa.js',
              window.wcv_dashboard_data.pluginDirUrl +
                '/dist/common/createLucideIcon.aebff54c.js',
              ...
              window.wcv_dashboard_data.pluginDirUrl +
                '/dist/common/antd.138ea4fd.js',
              window.wcv_dashboard_data.pluginDirUrl +
                '/dist/common/settings.11de4bb8.js',
              window.wcv_dashboard_data.pluginDirUrl + '/dist/main.5c2e1de1.js',
              window.wcv_dashboard_data.pluginDirUrl +
        ...
        a = $e(() =>
          Oe(
            () => import('../components/LicenseInfo.8ee101c0.js'),
            [
              window.wcv_dashboard_data.pluginDirUrl +
                '/dist/components/LicenseInfo.8ee101c0.js',
              window.wcv_dashboard_data.pluginDirUrl +
                '/dist/common/vendor.6b2451aa.js',
              window.wcv_dashboard_data.pluginDirUrl +
                '/dist/common/createLucideIcon.aebff54c.js',
